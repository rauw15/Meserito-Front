...
const RecuperarContraseña = () => {
    ...
    <section className="section-login">
        ...
        <div className='login-box'>
            ...
            <form action="">
                <Label classDiv='div-login' classNameLabel='label' msg='Correo electronico' 
                required='' onBlur='' onFocus='' id='' value='' placeholder='example@gmail.com' classNameInput='inputs' type='email' onChange=''/>
